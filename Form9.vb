Public Class Form9
    ...
    Private Sub klSPIAEffective_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles krbSPDAEffective.CheckedChanged
        kdtpSPDARateDate.Visible = True
    End Sub
    ...
    Private Sub klSPIACurrent_CheckedChanged(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles krbSPDACurrent.CheckedChanged
        kdtpSPDARateDate.Visible = False
    End Sub
